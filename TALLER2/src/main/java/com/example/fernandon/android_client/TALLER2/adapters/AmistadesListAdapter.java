...
import com.example.fernandon.android_client.TALLER2.utils.ListadoAmistadesFragment;
...
public class AmistadesListAdapter extends RecyclerView.Adapter<AmistadesListAdapter.AmistadesViewHolder> {
    ...
    public static class AmistadesViewHolder extends RecyclerView.ViewHolder {
        ...
        AmistadesViewHolder(View itemView) {
            super(itemView);
            mView = itemView;
            mPicture = (ImageView) itemView.findViewById(R.id.imgContactoNuevo);
            mName = (TextView) itemView.findViewById(R.id.nomContactoNuevo);
        }
    }
